  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Members and applicants awaiting an interpreting-department verdict on a language they reported speaking. Applicants to departments that assess before accepting come first. Verifying a member counts them as a provider for that language in scheduling."
      />
