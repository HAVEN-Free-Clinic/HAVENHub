...
export const scheduleDescriptors: TemplateDescriptor[] = [
  {
    ...
    variables: [
      ...
      { name: "requesterDate", label: "Requester shift date", sampleValue: "Saturday, July 11, 2026" },
      { name: "partnerDate", label: "Partner shift date", sampleValue: "Saturday, July 18, 2026" },
...
<p>${HUB_LINK}</p>`,
  },
  {
    ...
    variables: [
      ...
      { name: "requestsUrl", label: "Hub approvals link", sampleValue: "https://hub.havenfreeclinic.org/schedule/requests" },
      { name: "requesterName", label: "Requester first name", sampleValue: "Alex" },
      { name: "requesterDate", label: "Shift date", sampleValue: "Saturday, July 11, 2026" },
      { name: "departmentName", label: "Department name", sampleValue: "Internal Medicine" },
    ],
  ...
  // inside it is escaped where it is built (engine/request-digest.ts).
  {
    ...
    variables: [
      ...
      { name: "pendingSummary", label: "How many requests, e.g. \"3 shift requests\"", sampleValue: "3 shift requests" },
      {
        ...
        sampleValue:
          "<p><strong>Internal Medicine</strong><br/>Swap: Alex Johnson (Saturday, July 11, 2026) with Jordan Lee (Saturday, July 18, 2026), pending 4 days</p>",
      },
      {
        name: "escalationDays",
...
<p>${HUB_LINK}</p>`,
  },
  {
    ...
    variables: [
      ...
      { name: "clinicDateLabel", label: "Clinic date", sampleValue: "Saturday, July 18, 2026" },
