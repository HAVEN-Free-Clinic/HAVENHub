...
type SectionHeaderLevel = "eyebrow" | "title" | "card";
 ...
 * label; `title` is the larger non-uppercase subsection heading; `card` is the
 * quieter one used inside a card. Renders an h2
